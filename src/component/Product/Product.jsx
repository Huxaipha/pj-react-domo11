...
const Product = () => {
  ...
  const goToComparePage = () => {
    navigate('/compare', { state: { products: compareList } }); // Navigate to the compare page
  };
  ...
  const moreProducts = [
    {
      ...
      originalPrice: null,
      discount: null,
      image: 'https://res.cloudinary.com/dfo4alc3w/image/upload/v1726137828/Images_1_g5ohwz.png',
    ...
    },
    {
      ...
      discount: 'New',
      tagColor: 'bg-green-400',
      image: 'https://res.cloudinary.com/dfo4alc3w/image/upload/v1726137829/image_6_vwh5qr.png',
    ...
    },
    {
      ...
      originalPrice: 'Rp 14,000,000',
      discount: '50%',
      image: 'https://res.cloudinary.com/dfo4alc3w/image/upload/v1726137828/Images_2_iwqilc.png',
    ...
    },
    {
      ...
      discount: 'New',
      tagColor: 'bg-green-400',
      image: 'https://res.cloudinary.com/dfo4alc3w/image/upload/v1726137828/Images_3_gd6rqw.png',
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8 px-6">
        ...
        {initialProducts.map((product, index) => (
          <div key={index} className="relative bg-white p-4 rounded-lg shadow-md group">
            {product.discount && (
              <div
                className={`absolute right-4 top-4 ${product.tagColor || 'bg-red-500'} text-white px-3 py-1 text-sm font-bold w-[48px] h-[48px] rounded-full flex items-center justify-center`}
              >
            ...
            <div className="absolute inset-0 bg-black bg-opacity-50 flex-col flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              ...
              <div className="flex space-x-4 text-white justify-center items-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 mt-1">
                ...
                <button 
                  ...
                  onClick={() => {
                    toggleCompare(product);  // Toggle compare state for the product
                    goToComparePage(); // Navigate to the Compare page after toggling
                  }}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M8 12l2 2 4-4" />
                  </svg>
                  <span className="text-xs">{compareList.includes(product) ? 'Uncompare' : 'Compare'}</span>
                </button>
...
//                   className="text-sm"
//                 >
//                   {compareList.includes(product) ? 'Uncompare' : 'Compare'}
//                 </button>
...
//         {/* Show More Button */}
//         <div className="flex justify-center items-center text-center mt-8">
//           <button className="border border-yellow-400 text-yellow-300 px-6 py-2 rounded-lg hover:bg-yellow-600 hover:text-white transition-colors duration-300 flex items-center">
//             Show More
//           </button>
//         </div>
//       </div>
...
// const Product = () => {
//   const [cart, setCart] = useState([]); // Now useState is properly imported
...
//             {/* Prod className="text-sm"uct Details */}
//             <div className="mt-4 text-left">
//               <h3 className="text-xl font-semibold">{product.name}</h3>
//               <p className="text-sm text-gray-500">{product.description}</p>
//               <div className="flex justify-between items-center mt-2">
